...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "InlinePython":
		...
		case "ContainerEcho":
			...
			return (*InlinePython).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent InlinePython
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*InlinePython).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("InlinePython").
					WithFunction(
